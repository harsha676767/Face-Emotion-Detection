...
class Plain_Dataset(Dataset):
    def __init__(self, data_dir, transform=None):
        ...
        self.image_paths = []
        self.labels = []
        self.class_names = sorted(os.listdir(data_dir))  # Get class names from directory structure

        # Map class names (folder names) to labels
        ...
        for class_name in self.class_names:
            ...
            for img_name in os.listdir(class_dir):
                ...
                self.labels.append(self.class_to_idx[class_name])  # Assign the correct numeric label
